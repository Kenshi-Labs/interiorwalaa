  ...
  return (
    <section className="py-8 sm:py-12 lg:py-20 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="https://interiorwalaa.smepulse.in/getintouchbg.jpg"
      ...
      <div className="relative z-10">
        <div className="container mx-auto max-w-[1400px] px-4 sm:px-6 w-full">
          ...
          <div className="mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-black mb-2 font-['WorkSans']">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-[var(--light-cream)]/30 border border-[var(--primary-brown)] rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--primary-brown)] focus:border-transparent transition-all duration-300 text-black placeholder-gray-500 font-manrope text-sm sm:text-base"
                      />
                      {errors.fullName && (
                  ...
                  <div>
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-[var(--light-cream)]/30 border border-[var(--primary-brown)] rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-[var(--primary-brown)] focus:border-transparent transition-all duration-300 text-black placeholder-gray-500 font-manrope text-sm sm:text-base"
                    />
                    {errors.message && (
            ...
            <div className="relative">
              {/* Google Map */}
              <div className="relative rounded-[20px] sm:rounded-[30px] overflow-hidden shadow-2xl border-2 border-[var(--primary-brown)]">
                <div className="h-64 sm:h-80 lg:h-[330px]">
                  <iframe
                  ...
                  <div className="absolute bottom-0 left-0 right-0">
                    <div className="bg-black/60 text-white px-4 sm:px-6 py-3 sm:py-6 rounded-b-[20px] sm:rounded-b-[30px] -mx-px -mb-px">
