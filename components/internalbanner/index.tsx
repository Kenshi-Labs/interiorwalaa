    ...
    >
      <div className="h-full flex items-center relative z-10">
        <div className="">
          {/* Gradient backdrop */}
          <div
            className="backdrop-blur-sm px-4 sm:px-6 md:px-8 lg:px-12 py-4 sm:py-6 md:py-8 lg:py-12 xl:py-6 xl:px-16 max-w-2xl md:max-w-3xl lg:max-w-4xl"
            style={{
              background: getGradientStyle()
            }}
          >
            <h1 className="text-[#FDFEFF] text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 sm:mb-4 md:mb-3 leading-tight">
              {title}
            </h1>
            <p className="text-[#FDFEFF] text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed opacity-95">
              {subtitle}
            </p>
          </div>
        </div>
